...
class _HomePageState extends State<HomePage> {
  ...
  bool hireMe = false;
  bool resume = false;
  bool aboutMeCheck = false;
  bool portfolioCheck = false;
              ...
              return Column(
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      setState(() {
                        aboutMeCheck = !aboutMeCheck;
                      });
                    },
                    child: Ink(
                      decoration: aboutMeCheck
                          ? BoxDecoration(
                        borderRadius: BorderRadius.circular(12),
                        gradient: LinearGradient(
                          colors: [
